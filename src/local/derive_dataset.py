...
def add_targets(df: pd.DataFrame, *, horizons: list[int], scaler_params: dict[str, Any]) -> pd.DataFrame:
...
def derive_dataset_local(
    ...
    *,
    ...
    train_df2 = add_targets(train_df, horizons=horizons, scaler_params=scaler_params)
    val_df2 = add_targets(val_df, horizons=horizons, scaler_params=scaler_params)
    test_df2 = add_targets(test_df, horizons=horizons, scaler_params=scaler_params)
